...
class howto_compare_vector_cci_sptr(object):
    """Proxy of C++ boost::shared_ptr<(howto_compare_vector_cci)> class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """
        __init__(self) -> howto_compare_vector_cci_sptr
        __init__(self,  p) -> howto_compare_vector_cci_sptr
        """
        this = _howto_swig.new_howto_compare_vector_cci_sptr(*args)
        try: self.this.append(this)
        except: self.this = this
    def __deref__(self):
        """__deref__(self)"""
        return _howto_swig.howto_compare_vector_cci_sptr___deref__(self)
    ...
    def general_work(self, *args, **kwargs):
        ...
        """
        return _howto_swig.howto_compare_vector_cci_sptr_general_work(self, *args, **kwargs)

    def history(self):
        """history(self) -> unsigned int"""
        return _howto_swig.howto_compare_vector_cci_sptr_history(self)

    def output_multiple(self):
        """output_multiple(self) -> int"""
        return _howto_swig.howto_compare_vector_cci_sptr_output_multiple(self)

    def relative_rate(self):
        """relative_rate(self) -> double"""
        return _howto_swig.howto_compare_vector_cci_sptr_relative_rate(self)

    def start(self):
        """start(self) -> bool"""
        return _howto_swig.howto_compare_vector_cci_sptr_start(self)

    def stop(self):
        """stop(self) -> bool"""
        return _howto_swig.howto_compare_vector_cci_sptr_stop(self)

    def nitems_read(self, *args, **kwargs):
        """nitems_read(self, unsigned int which_input) -> uint64_t"""
        return _howto_swig.howto_compare_vector_cci_sptr_nitems_read(self, *args, **kwargs)

    def nitems_written(self, *args, **kwargs):
        """nitems_written(self, unsigned int which_output) -> uint64_t"""
        return _howto_swig.howto_compare_vector_cci_sptr_nitems_written(self, *args, **kwargs)

    def detail(self):
        """detail(self) -> gr_block_detail_sptr"""
        return _howto_swig.howto_compare_vector_cci_sptr_detail(self)

    def set_detail(self, *args, **kwargs):
        """set_detail(self, gr_block_detail_sptr detail)"""
        return _howto_swig.howto_compare_vector_cci_sptr_set_detail(self, *args, **kwargs)

    def name(self):
        """name(self) -> string"""
        return _howto_swig.howto_compare_vector_cci_sptr_name(self)

    def input_signature(self):
        """input_signature(self) -> gr_io_signature_sptr"""
        return _howto_swig.howto_compare_vector_cci_sptr_input_signature(self)

    def output_signature(self):
        """output_signature(self) -> gr_io_signature_sptr"""
        return _howto_swig.howto_compare_vector_cci_sptr_output_signature(self)

    def unique_id(self):
        """unique_id(self) -> long"""
        return _howto_swig.howto_compare_vector_cci_sptr_unique_id(self)

    def to_basic_block(self):
        """to_basic_block(self) -> gr_basic_block_sptr"""
        return _howto_swig.howto_compare_vector_cci_sptr_to_basic_block(self)

    def check_topology(self, *args, **kwargs):
        """check_topology(self, int ninputs, int noutputs) -> bool"""
        return _howto_swig.howto_compare_vector_cci_sptr_check_topology(self, *args, **kwargs)

howto_compare_vector_cci_sptr_swigregister = _howto_swig.howto_compare_vector_cci_sptr_swigregister
howto_compare_vector_cci_sptr_swigregister(howto_compare_vector_cci_sptr)
